...
function myFunction(){document.getElementById("myDropdown").classList.toggle("show")}function myFunctionHeadphones(){document.getElementById("myHeadphones").classList.toggle("show")}function myFunctionWireless(){document.getElementById("myWireless").classList.toggle("show")}function myFunctionFind(){document.getElementById("myFind").classList.toggle("show")}if($(function(){$(".menu a, .totop").on("click",function(e){e.preventDefault();e=$(this).attr("href"),e=$(e).offset().top;$("body,html").animate({scrollTop:e},1500)}),$(".slider-blog__inner").slick({arrows:!1,prevArrow:'<button type="button" class="slick-prev"><img src="img/arrow-left.svg" alt="img/arrow-left.svg" /></button>',nextArrow:'<button type="button" class="slick-next"><img src="img/arrow-right.svg" alt="img/arrow-right.svg" /></button>',dots:!0,autoplay:!0,autoplaySpeed:3e3,fade:!0,responsive:[{breakpoint:768,settings:{arrows:!1}}]}),$(".menu__btn, .menu a").on("click",function(){$(".menu__list").toggleClass("menu__list--active")})}),window.onclick=function(e){if(!e.target.matches(".dropbtn"))for(var t=document.getElementsByClassName("dropdown-content"),s=0;s<t.length;s++){var n=t[s];n.classList.contains("show")&&n.classList.remove("show")}},document.querySelector(".stepper"),vars.$stepper){const i=vars.$stepper.querySelector(".stepper__input"),j=vars.$stepper.querySelector(".stepper__btn--minus"),k=vars.$stepper.querySelector(".stepper__btn--plus");i.addEventListener("keydown",e=>{console.log(e.currentTarget.value),(e.currentTarget.value<=1?(j.classList.add("stepper__btn--disabled"),k):j).classList.remove("stepper__btn--disabled"),99998<e.currentTarget.value?(j.classList.remove("stepper__btn--disabled"),k.classList.add("stepper__btn--disabled")):k.classList.remove("stepper__btn--disabled")}),k.addEventListener("click",e=>{var t=parseInt(i.value);t++,i.value=t,j.classList.remove("stepper__btn--disabled"),99998<i.value?(i.value=99999,k.classList.add("stepper__btn--disabled")):k.classList.remove("stepper__btn--disabled")}),j.addEventListener("click",e=>{var t=parseInt(i.value);t--,i.value=t,k.classList.remove("stepper__btn--disabled"),i.value<=1?(i.value=1,j.classList.add("stepper__btn--disabled")):j.classList.remove("stepper__btn--disabled")})}